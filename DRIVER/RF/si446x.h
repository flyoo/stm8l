...
#define PIN_SI_CSN      GPIO_Pin_0

#define PORT_SI_SDN     GPIOD
#define PIN_SI_SDN      GPIO_Pin_0
...
#define SI_CSN_LOW()   GPIO_ResetBits(PORT_SI_CSN, PIN_SI_CSN);
#define SI_CSN_HIGH()  GPIO_SetBits(PORT_SI_CSN, PIN_SI_CSN);
